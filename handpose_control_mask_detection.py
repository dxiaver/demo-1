...
if __name__ == '__main__':
    ...
    human_detector_mp = MPPersonDet(modelPath='./opencv_zoo/models/person_detection_mediapipe/person_detection_mediapipe_2023mar.onnx',
                                    nmsThreshold=0.3,
                                    ...
                                    targetId=target)
    # nano detector
    human_detector_nano = NanoDet(modelPath='./opencv_zoo/models/object_detection_nanodet/object_detection_nanodet_2022nov.onnx',
                                  prob_threshold=0.5,
                                  iou_threshold=0.6,
                                  backend_id=backend,
                                  target_id=target)
    ...
    face_detector = YuNet(modelPath='./opencv_zoo/models/face_detection_yunet/face_detection_yunet_2022mar.onnx',
                          ...
                          targetId=target)
    # palm detector
    palm_detector = MPPalmDet(modelPath='./opencv_zoo/models/palm_detection_mediapipe/palm_detection_full_mediapipe_2023feb.onnx',
                              nmsThreshold=0.3,
                              ...
                              targetId=target)
    # handpose detector
    handpose_detector = MPHandPose(modelPath='./opencv_zoo/models/handpose_estimation_mediapipe/handpose_estimation_full_mediapipe_2023feb.onnx',
    ...
    while True:
        ...
        if gestures.shape[0] != 0:
            ...
            if not Develop_Mode or (gesture_buffer[0] is not None and all(ges == gesture_buffer[0] for ges in gesture_buffer)):
